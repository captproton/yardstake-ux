...
# ---------------------------------------------------------------------------
# the geometry kernel -- adu_kit/kernel.py (#126)
# ---------------------------------------------------------------------------
# Nothing in the kernel knows this building, so it lives in the kit. Its
# names are imported here, not only used: the gates, views.py and
# finish_adu.py import them from this module (`from build_adu import
# load_spec, ft`), and none of them changes.
