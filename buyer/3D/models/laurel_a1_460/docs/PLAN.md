...
8. [#132](https://github.com/captproton/yardstake-ux/issues/132) **Done**, in two PRs (decided 2026-09-24: P3b first, because it moves what the trim wraps).
...
9. [#119](https://github.com/captproton/yardstake-ux/issues/119) **Next.** **Declare where each footprint sits**, so the overlay stops centring. A page change, before Laurel's dimensions are trusted.
